...
![Habit Tracker Screenshot](./client/src/assets/app1.png)

### 2. Voice-to-Text Journaling
![Voice-to-Text Screenshot](./client/src/assets/app3.png)

### 3. Goal Setting Dashboard
![Goal Setting Screenshot](./client/src/assets/app2.png)
